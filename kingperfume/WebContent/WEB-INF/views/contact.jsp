	...
	<div class="site-section mb-3">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-7">
					<form:form action="contact/insert.htm" method="post" modelAttribute="contact">
				...
				<div class="col-md-5 ml-auto">
					<div class="p-4 border mb-3">
						...
						<p class="mb-0">B2-08A KĐT Vinhomes Gardenia, Đường Hàm Nghi, P. Cầu Diễn, Nam Từ Liêm, Hà Nội</p>
					</div>
					<div class="p-4 border mb-3">
						<span class="d-block text-primary h6 text-uppercase">Đã Nẵng</span>
						<p class="mb-0">183 Trung Kính, Yên Hòa, Đà Nẵng</p>
					</div>
					<div class="p-4 border mb-3">
