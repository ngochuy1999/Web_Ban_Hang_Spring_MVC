								...
								<div class="mailbox-border">
									<div class="mail-toolbar clearfix">
										<div class="float-left">
											...
											<div class="btn btn_1 btn-default mrg5R">
												<a href="admin/product/insert.htm"><i class="fa fa-plus"></i></a>
											</div>
											...
											<div class="btn-group">
												...
												<c:forEach var="i" begin="0" end="${page}">
													<a class="btn btn-default"
														href="admin/product/${i+1}.htm"><c:out
															value="${i+1}" /></a>
												</c:forEach>
											...
											<c:forEach var="item" items="${listProduct}">
												<tr class="unread checked">
													...
													<td style="text-align: center; width: 150px;"><a
														...
														href="admin/product/update/${item.id}.htm"><i
															class="fa fa-edit"></i></a> <a class="btn btn-default"
														href="admin/product/remove/${item.id}.htm"><i
