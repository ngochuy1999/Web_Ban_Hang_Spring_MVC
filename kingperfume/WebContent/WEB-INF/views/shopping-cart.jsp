							...
							<tbody>
								<c:forEach var="map" items="${sessionScope.myCartItems}">
									<tr>
										...
										<td><a
											href="${pageContext.request.contextPath}/shopping-cart/remove/${map.value.product.id}.htm"
							...
							<div class="row">
								<div class="col-md-12">
									<a class="btn btn-primary btn-lg py-3 btn-block"
										href="${pageContext.request.contextPath}/shopping-cart/paying.htm">Thanh Toán</a>
								</div>
							</div>
						</div>
					</div>
